...
locals {
  ...
  container_image     = "${local.container_image_base}/cap-frontend:agaile"
}
  ...
  container_secrets = [
    {
      ...
      valueFrom = "${aws_secretsmanager_secret.agaile_env.arn}:LANGCHAIN_API_KEY::"
    },
    {
      name      = "LANGGRAPH_API_URL"
      valueFrom = "${aws_secretsmanager_secret.agaile_env.arn}:LANGGRAPH_API_URL::"
    },
    {
      name      = "NEXT_PUBLIC_LANGGRAPH_ASSISTANT_ID"
      valueFrom = "${aws_secretsmanager_secret.agaile_env.arn}:NEXT_PUBLIC_LANGGRAPH_ASSISTANT_ID::"
    }
  ]
...
output "alb_arn" {
  description = "ARN of the ALB for Agaile"
